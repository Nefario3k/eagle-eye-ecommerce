      ...
      <v-row class="footer_row">
        <aside class="col-12 col-sm-12 col-md-4 col-lg-4">
          <div class="footer_left">
            ...
            <p class="subtext">
              Buy and sell products easy with the Eagle Eye Escrow Ecommerce
              platform, with over 50+ offical stores and over 100,000+ products,
              whatever you need, its all right here!
            </p>
          </div>
        </aside>
        <aside class="footer_right row col-12 col-sm-12 col-md-8 col-lg-8">
          ...
          <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <ul class="footerLinkList">
              ...
              <li class="footerLink">
                <nuxt-link to="/vendor">Escrow Vendors</nuxt-link>
              </li>
              <li class="footerLink">
                <nuxt-link to="/partner">Partnership</nuxt-link>
              </li>
            </ul>
          </div>
          <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
            <ul class="footerLinkList">
              ...
              <li class="footerLink">
                <nuxt-link to="/wish-list">Wish List</nuxt-link>
              </li>
              <li class="footerLink">
                <nuxt-link to="/order">Order History</nuxt-link>
              </li>
              <li class="footerLink">
                <nuxt-link to="/track">Track Package</nuxt-link>
              </li>
            </ul>
          </div>
        </aside>
        <v-divider class="divider col-12"></v-divider>
        <div class="col-12 footerBottomContainer">
          <div
            class="footerRef d-flex align-items-center justify-content-between"
          >
            <p class="copyrights">
              ©2023 - Eagle Eye Escrow Ecommerce. All rights reserved.
            </p>
            <div class="footerSocials">
              <nuxt-link title="Facebook" to=""
                ><svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
...
.footerLinkList .header {
  font-weight: 500;
  font-size: 2.4rem;
  margin-bottom: 13px;
}
.footerLinkList .footerLink a {
...
.footerLinkList .footerLink a:hover {
  color: var(--primary-color);
}
.footerLinkList .footerLink a.nuxt-link-exact-active.nuxt-link-active {
  color: var(--primary-color);
}
.divider {
  background: #e8e6f9;
